(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_d69a9303._.js", {
...
function FeedPage() {
    ...
    const fetchPosts = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('submissions').select('id, content, created_at, profiles(name, avatar_url)').order('created_at', {
            ascending: false
        });
...
_s(FeedPage, "gpXJ9XQDnsXk9NSTMZsE5j94QhY=", false, function() {
    return [
...
//# sourceMappingURL=_d69a9303._.js.map