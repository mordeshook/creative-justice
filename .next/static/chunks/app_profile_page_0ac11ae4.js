(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_profile_page_0ac11ae4.js", {
...
function ProfilePage() {
    ...
    const fetchPosts = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('submissions').select('id, content, created_at').eq('user_id', user.id).order('created_at', {
            ascending: false
        });
        if (error) {
...
_s(ProfilePage, "/BOXWSTyMv8X0620HJ1DkFINnaw=", false, function() {
    return [
